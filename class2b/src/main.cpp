...
int main(int argc, char *argv[]) { 
	...
	//In order to properly handle the value of the pointe member we need a Deep copy constructor
	MathUtils m_utils1(99, 32);

	// class2a: Below, the Deep copy constructor is getting invoked
	MathUtils m_utils = m_utils1;		
